...
class FSM:
    ...
    def setup_rules(self):
        ...
        self.add_rule(self.switch[2],
                      self.switch[2],
                      FSM.all[2:],
                      self.agent.append_password_buffer)
        self.add_rule(
            self.switch[2],
            self.switch[3],
            FSM.all[1],
            self.agent.verify_login)
        self.add_rule(
            self.switch[2],
            self.switch[1],
            FSM.all,
            self.agent.reset_all_variables)
        ...
        self.add_rule(
            ...
            FSM.all,
            self.agent.nothing)
        self.add_rule(self.switch[7], self.switch[7],
                      FSM.all[2:], self.agent.append_new_pass)
        self.add_rule(
            self.switch[7],
            self.switch[4],
            FSM.all[0],
        ...
        self.add_rule(
            ...
            FSM.all[1],
            self.agent.nothing)
        self.add_rule(self.switch[8], self.switch[8],
                      FSM.all[2:], self.agent.append_new_pass_check)
        self.add_rule(
            self.switch[8],
            self.switch[4],
            FSM.all[1],
            self.agent.validate_password_change)
        self.add_rule(
            self.switch[8],
            self.switch[4],
            FSM.all[0],
        ...
        # Opplysing av LEDS
        self.add_rule(self.switch[4], self.switch[11],
                      FSM.all[2:8], self.agent.set_led)
        self.add_rule(
            self.switch[11],
            self.switch[12],
            FSM.all[1],
        ...
        self.add_rule(
            ...
            FSM.all,
            self.agent.reset_all_variables)
        self.add_rule(self.switch[12], self.switch[12],
                      FSM.all[2:], self.agent.append_Ldur)
        self.add_rule(
            self.switch[12],
            self.switch[4],
            FSM.all[1],
